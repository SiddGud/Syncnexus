...
class EmployeePaymentsCubit extends Cubit<EmployeePaymentsState> {
  EmployeePaymentsCubit({required this.employeeId})
      : super(EmployeePaymentsLoading()) {
    getThisEmployeePayments();
  }

  final String employeeId;
  late List<Payment> payments;

  void getThisEmployeePayments() async {
